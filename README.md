# ML Engineering · Model Evaluation Engineer — Solutions Repository
...
Reference implementations for the paired [`model-evaluation-engineer-learning`](https://github.com/ml-engineering-curriculum/model-evaluation-engineer-learning) track.
...
```
model-evaluation-engineer-solutions/
